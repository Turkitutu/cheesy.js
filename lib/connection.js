...
class Connection extends EventEmitter {
	 ...
	 * @param {enums.cipherMethod} [method=enums.cipherMethod.without] - The algorithm method to cipher the packet with it.
	 */
	send(identifier, packet, method=cipherMethod.without){
