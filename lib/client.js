	...
	handleTribulle(code, packet){
		if (code == 66){
			...
			*/
            ...
            let soulmate = (new Friend(packet, true)) // soulmate
            ...
            while (totalFriends--) {
                friends.push(new Friend(packet, false));
            }

            /**
                * Emmitted when the client received the friend list
                * @event Client#friendList
                * @property {Friend[]} friends - An array of friends
                * @property {String|null} - The name of the soulmate, `null` if absent
             */
